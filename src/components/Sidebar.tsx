    ...
    <aside className="w-64 fixed left-0 top-0 h-screen bg-[#0a0a0a] text-stone-300 p-6 hidden lg:flex flex-col border-r border-stone-800 z-40">
      ...
      <div className="mb-6">
        <h1 className="font-medium text-xl text-gold-500 leading-tight">
          {activeCourseId === 1 ? 'Design de Sobrancelhas' : activeCourseId === 2 ? 'Henna para Sobrancelhas' : activeCourseId === 3 ? 'Tintura para Sobrancelhas' : activeCourseId === 4 ? 'Protocolo de Crescimento' : activeCourseId === 5 ? 'Brow Repair' : activeCourseId === 6 ? 'Brow Lamination' : 'Lash Lifting'}
        </h1>
      </div>
